function AO_neinversor(R1,R2,VAL,Val,A,N,F,semnal)
...
if R2==0
    f = errordlg('Ai obtinut un repetor de tensiune!','Info');
end
if R1<0||R2<0
...
elseif F>2600
    f = errordlg('Frecventa este prea mare. (max:2600)','Error');
end
...
'FontSize',10,... 
'String','Amplificator AO Neiversor|Amplificator AO Inversor',...
'Callback','close;AO_inversor(R1,R2,VAL,Val,A,N,F,semnal)');

% ========== imagine ===================%
img = imread('neinversor.png');
image(img);
x = 0.05;
y = 0.6;
...
'Value',semnal,...
'Callback','semnal=get(gco,''Value'');close;AO_neinversor(R1,R2,VAL,Val,A,N,F,semnal)')
